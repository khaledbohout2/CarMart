...
//  CarMart
//
//  Created by Khaled Bohout on 07/02/2021.
//

import UIKit
import DateTimePicker

class BookCarWashVC: UIViewController {
    ...
    @IBAction func showPickerBtnTapped(_ sender: Any) {
...
extension BookCarWashVC: DateTimePickerDelegate {
